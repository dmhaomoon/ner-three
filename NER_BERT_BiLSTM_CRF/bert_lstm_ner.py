...
if os.name == 'nt':
    bert_path = r'E:\cbackup\Desktop\code\github\nlp\bert-kbqa\NER_BERT_BiLSTM_CRF\bert\chinese_L-12_H-768_A-12'
    root_path = r'E:\cbackup\Desktop\code\github\nlp\bert-kbqa\NER_BERT_BiLSTM_CRF'
else:
    bert_path = '/data/menghao/yun2space/NER_BERT_BiLSTM_CRF/bert/bert-wwm-ext/'
    root_path = '/data/menghao/yun2space/NER_BERT_BiLSTM_CRF/'
print('a')
flags.DEFINE_string(
...
flags.DEFINE_string(
    "output_dir", os.path.join(root_path, 'output_book'),
...
class NerProcessor(DataProcessor):
    def get_train_examples(self, data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, "train_book.data")), "train"
        )

    def get_dev_examples(self, data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, "dev_book.data")), "dev"
        )

    def get_test_examples(self, data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, "test_book.data")), "test")

    def get_labels(self):
        return ["O", "B-PER", "I-PER", "B-ORG", "I-ORG", "B-LOC", "I-LOC", "X", "[CLS]", "[SEP]",'B-ACCOUNTANT', 'I-ACCOUNTANT', 'B-TIMI', 'I-TIMI','B-NUMBIR', 'B-BI', 'I-NUMBIR', 'B-PIRBON', 'I-PIRBON', 'I-BI']
...
if __name__ == "__main__":
    ...
    output_dir ="./output_qa/result_dir_ner/"
    tf.app.run()
    # filter model
